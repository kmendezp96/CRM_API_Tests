Feature: update customer
  ...
  Scenario Outline: Update a new customer
    Given I have access to CRM "customer/<id>" service with "all permission"
    ...
    Examples:
      ...
      | 2e13c549-8d83-46e5-9f40-c87de47159a3   | David      | Garza    | 1066  Camden Street | Reno | 775-378-6153 | mobile          |      algo@gmail.com          | 32  |
